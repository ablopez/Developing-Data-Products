...
```{r libraries0, include=FALSE, results='hide'}
if (!require("yaml")) {
...
```{r libraries, echo=FALSE  ,include=FALSE, results='hide'}
...
```{r Plot2, echo=FALSE, fig.height=2.5, fig.width= 10}
...
```{r Plot1, echo=FALSE, fig.height=2.5, fig.width= 10}
